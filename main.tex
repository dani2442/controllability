...
\begin{abstract}
  We study deterministic experiment design for continuous-time linear time-invariant systems with the goal of certifying controllability properties directly from data. We develop a continuous-time, data-driven analogue of the Hautus (PBH) test based on residual Gramians and a derivative-free cross-moment formulation, and we provide basic high-probability error bounds under an It\^o noise model.
