...
Specifically, the operator formulation developed in Section~\ref{subsec:hautus-operator} shows that rank deficiency of $\mat{G}_\lambda(u)$ can only occur when $\lambda$ belongs to the spectrum of the data-driven matrix
\[
