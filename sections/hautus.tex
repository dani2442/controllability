...
\[
  m_\lambda(t)=(\mat{A}-\lambda \mat{I})x(t)+\mat{B}u(t)=\mat{P}_\lambda z(t),
\]
and therefore
...
\begin{equation}\label{eq:hautus-cross-moment-G-from-H}
  \mat{G}_\lambda(u):=\int_0^T m_\lambda(t)m_\lambda(t)^*\,\d t=\mat{P}_\lambda\mat{S}_Z(u)\mat{P}_\lambda^*=\mat{H}_\lambda(T)\mat{S}_Z(u)^{-1}\mat{H}_\lambda(T)^*
\end{equation}
%
%
